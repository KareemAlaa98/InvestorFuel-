    ...
    return (
        <div className='container w-100'>
            ...
            <div className="cardsContainer">
                <MDBCard className='mb-5 serviceCard' style={{ maxWidth: '1100px' }}>
                    <MDBRow className='g-0'>
                        ...
                        <MDBCol md='8'>
                            <MDBCardBody>
                                <MDBCardTitle > <a className='text-dark' href='#'><h4>Cold Callers</h4></a></MDBCardTitle>
                                <MDBCardText>
                                    <p>
                ...
                <MDBCard className='mb-5 serviceCard' style={{ maxWidth: '1100px' }}>
                    <MDBRow className='g-0'>
                        ...
                        <MDBCol md='8'>
                            <MDBCardBody>
                                <MDBCardTitle> <a className='text-dark' href='#'> <h4>Lead Managers</h4> </a></MDBCardTitle>
                                <MDBCardText>
                                    <p>
                ...
                <MDBCard className='mb-5 serviceCard' style={{ maxWidth: '1100px' }}>
                    <MDBRow className='g-0'>
                        ...
                        <MDBCol md='8'>
                            <MDBCardBody>
                                <MDBCardTitle> <a className='text-dark' href='#'><h4>ACQs</h4> </a></MDBCardTitle>
                                <MDBCardText>
                                    <p>
                ...
                <MDBCard className='mb-5 serviceCard'>
                    <MDBRow className='g-0'>
                        <MDBCol md='4'>
                        ...
                        <MDBCol md='8'>
                            <MDBCardBody>
                                <MDBCardTitle> <a className='text-dark' href='#'> <h4>Appointment Setters </h4> </a></MDBCardTitle>
                                <MDBCardText>
                                    <p>
